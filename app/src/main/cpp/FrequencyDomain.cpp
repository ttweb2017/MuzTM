...
Java_com_voicetm_testingrecord_MainActivity_FrequencyDomain(JNIEnv * __unused env, jobject __unused obj, jint samplerate, jint buffersize) {
...
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_Cleanup(JNIEnv * __unused env, jobject __unused obj) {
    delete audioIO;
    free(magnitudeLeft);
    free(magnitudeRight);
    free(phaseLeft);
