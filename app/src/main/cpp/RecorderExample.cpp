...
Java_com_voicetm_testingrecord_MainActivity_StartAudio (
        JNIEnv *env,
...
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_StopRecording(JNIEnv * __unused env, jobject __unused obj) {
    recorder->stop();
    delete audioIO;
...
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onBackground(JNIEnv * __unused env, jobject __unused obj) {
    audioIO->onBackground();
}

// onForeground - Resume audio processing.
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onForeground(JNIEnv * __unused env, jobject __unused obj) {
