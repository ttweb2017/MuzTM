...
Java_com_voicetm_testingrecord_MainActivity_CrossExample(
		JNIEnv *env,
...
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onPlayPause(JNIEnv * __unused env, jobject __unused obj, jboolean play) {
	example->onPlayPause(play);
}

// onCrossfader - Handle crossfader events.
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onCrossfader(JNIEnv * __unused env, jobject __unused obj, jint value) {
	example->onCrossfader(value);
}

// onFxSelect - Handle FX selection.
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onFxSelect(JNIEnv * __unused env, jobject __unused obj, jint value) {
	example->onFxSelect(value);
}

// onFxOff - Turn of all effects.
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onFxOff(JNIEnv * __unused env, jobject __unused obj) {
	example->onFxOff();
}

// onFxValue - Adjust FX value.
extern "C" JNIEXPORT void
Java_com_voicetm_testingrecord_MainActivity_onFxValue(JNIEnv * __unused env, jobject __unused obj, jint value) {
