package com.voicetm.testingrecord;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        // Initialize the FrequencyDomain library
    ...
    public void CrossExample_PlayPause(View button) {
        ...
        if (playing) {
            FrequencyDomain(samplerate, buffersize);
        } else {
            Cleanup();
        }

        // Start or stop recording voices here
        /*if (recording) {
            StopRecording();
            recording = false;
        } else {
        ...
        if (b != null) b.setText(playing ? "Pause / Save" : "Play / Record");
    }
